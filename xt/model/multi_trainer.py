...
class MultiTrainerModel(object):
    ...
    def train(self, state, label):
        ...
        # print("send_train_data ========================= {}".format(time() - start))

        # more time
        result = self.model_.train(state_split, label_split)
        return result
...
class MultiTrainer(object):
    ...
    def train(self, recv_data):
        ...
        # print("self.model.train time ===================== {}".format(time() - start))
...
def create_multi_trainer(gpu_nums, model_info):
    ...
    #     else:
    #         print("i==================={}".format(i))
    #         trainer_q.append(create_trainer(i, model_info, i))
